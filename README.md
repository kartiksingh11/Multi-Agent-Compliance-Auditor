...
git clone https://github.com/your-username/compliagent.git
...
Researcher retrieves relevant context from vector database
Generator creates an answer using the retrieved context
Critic verifies whether the answer is fully grounded
